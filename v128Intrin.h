...
#else
namespace _vectorbackendnamespace_::Vectorization::Intrinsic::v128 {
	using r128i = __m128i;
	...
	_vectorbackendforceinline _vectorbackendnodiscardmsg("Vector functions cannot have their return values discarded")
	...
	_vectorbackendforceinline
		_vectorbackendnodiscardmsg("Vector functions cannot have their return values discarded")
		r128i zero() {
...
// logical left shift
	...
	_vectorbackendforceinline
		_vectorbackendnodiscardmsg("Vector insert results must not be discarded")
	...
	_vectorbackendforceinline
		_vectorbackendnodiscardmsg("Vector extract results must not be discarded")
	...
	_vectorbackendforceinline
		_vectorbackendnodiscardmsg("Vector dot product results must not be discarded")
	...
	_vectorbackendforceinline
		_vectorbackendnodiscardmsg("Scalar math results must not be discarded")
	...
	_vectorbackendforceinline
		_vectorbackendnodiscardmsg("Scalar rounding results must not be discarded")
	...
	_vectorbackendforceinline
		_vectorbackendnodiscardmsg("Scalar conversion results must not be discarded")
	...
	_vectorbackendforceinline r128f64 cast(r128f32 v) { return _mm_castps_pd(v); }
	_vectorbackendforceinline r128f32 cast(r128f64 v) { return _mm_castpd_ps(v); }

	_vectorbackendforceinline r128i  castInt(r128f32 v) { return _mm_castps_si128(v); }
	_vectorbackendforceinline r128f32 castFloat(r128i v) { return _mm_castsi128_ps(v); }

	_vectorbackendforceinline r128i  castInt(r128f64 v) { return _mm_castpd_si128(v); }
	_vectorbackendforceinline r128f64 castDouble(r128i v) { return _mm_castsi128_pd(v); }
